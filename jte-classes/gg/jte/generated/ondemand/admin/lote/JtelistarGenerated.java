package gg.jte.generated.ondemand.admin.lote;
public final class JtelistarGenerated {
	public static final String JTE_NAME = "admin/lote/listar.jte";
	public static final int[] JTE_LINE_INFO = {0,0,0,0,2,2,2,4,4,6,8,16,16,17,17,19,19,19,24,24,25,25,30,30,30,31,31,31,31,31,31,31,42,42,49,49,50,50,51,51,52,52,54,54,54,59,59,60,60,61,64,69,92,92,94,94,94,95,95,95,96,96,96,97,97,97,99,99,99,102,102,102,107,107,112,114,119,121,125,125};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, edu.unam.jte.paginas.ModeloLotes modelo) {
		...
		if (modelo.excepcion != null) {
			...
			jteOutput.writeContent("\n        ");
			if (modelo.eliminado != 0) {
				jteOutput.writeContent("\n          <div class=\"alert alert-dark alert-dismissible fade show\" role=\"alert\">\n            Se ha recuperado el lote con ID = ");
				jteOutput.setContext("div", null);
				jteOutput.writeUserContent(modelo.eliminado);
				jteOutput.writeContent("\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n        ");
			}
		...
		for (var lote : modelo.lotes) {
			...
			jteOutput.setContext("td", null);
			jteOutput.writeUserContent(lote.getAbajoIzquierda_toString());
			jteOutput.writeContent("</td>\n                      <td>");
			jteOutput.setContext("td", null);
			jteOutput.writeUserContent(lote.getArribaDerecha_toString());
			jteOutput.writeContent("</td>\n                      <td>");
			jteOutput.setContext("td", null);
			jteOutput.writeUserContent(lote.getProductor().toString());
			jteOutput.writeContent("</td>\n                      <td>\n                        <a type=\"button\" class=\"btn btn-warning btn-xs no-gutters\" href=\"/admin/lotes/");
			jteOutput.setContext("a", "href");
			jteOutput.writeUserContent(lote.getIdLote());
			jteOutput.writeContent("\">\n                          <i class=\"fas fa-edit\"></i>\n                        </a>\n                        <a type=\"button\" class=\"btn btn-danger btn-xs no-gutters\" onClick=\"borrar(&quot;lotes&quot;,");
	...
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		edu.unam.jte.paginas.ModeloLotes modelo = (edu.unam.jte.paginas.ModeloLotes)params.get("modelo");
