...
public final class JtelistarGenerated {
	public static final String JTE_NAME = "admin/cuadro/listar.jte";
	...
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, edu.unam.jte.paginas.ModeloCuadros modelo) {
		...
		if (modelo.excepcion != null) {
			...
			if (modelo.excepcion != "") {
				...
				if (modelo.eliminado != 0) {
					jteOutput.writeContent("\n            <form action=\"/admin/cuadros\" method=\"post\" id=\"form\">\n              <div class=\"alert alert-info alert-dismissible fade show\" role=\"alert\"\n              style=\"margin-bottom: 0px;padding-bottom: 0px;\">\n                <p>\n                  El cuadro con ID = ");
					...
					jteOutput.writeContent("\n            <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">\n              El cuadro se ha actualizado correctamente\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n            </div>\n          ");
				}
				jteOutput.writeContent("\n        ");
			}
			jteOutput.writeContent("\n      ");
			...
			jteOutput.writeContent("\n        ");
			if (modelo.eliminado != 0) {
				jteOutput.writeContent("\n          <div class=\"alert alert-dark alert-dismissible fade show\" role=\"alert\">\n            Se ha recuperado el cuadro con ID = ");
				jteOutput.setContext("div", null);
				jteOutput.writeUserContent(modelo.eliminado);
				jteOutput.writeContent("\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n        ");
			}
	...
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		edu.unam.jte.paginas.ModeloCuadros modelo = (edu.unam.jte.paginas.ModeloCuadros)params.get("modelo");
