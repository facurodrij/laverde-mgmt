...
public final class JteeditarGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,0,0,2,2,2,4,4,6,8,19,19,19,23,26,31,45,45,45,46,46,46,46,46,46,46,53,53,53,53,53,53,53,61,61,61,61,61,61,61,69,69,69,69,69,69,69,73,78,81,86,88,92,92};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, edu.unam.jte.paginas.ModeloProductor modelo) {
		...
		jteOutput.writeContent("\" method=\"post\" id=\"productor\">\r\n                    <input class=\"form-control\" type=\"hidden\" id=\"idProductor\"");
		if (gg.jte.runtime.TemplateUtils.isAttributeRendered(modelo.productor.getIdProductor())) {
