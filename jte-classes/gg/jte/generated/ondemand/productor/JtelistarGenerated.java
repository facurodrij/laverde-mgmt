...
public final class JtelistarGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,1,1,3,3,3,5,5,7,9,23,26,31,63,63,65,65,65,66,66,66,67,67,67,68,68,68,70,70,70,73,73,73,78,78,83,85,90,92,94,94};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, ModeloProductores modelo) {
		...
		for (var productor : modelo.productores) {
			...
			jteOutput.writeContent("</td>\r\n                                    <td>\r\n                                        <a type=\"button\" class=\"btn btn-warning btn-xs no-gutters\" href=\"/productores/");
			jteOutput.setContext("a", "href");
			jteOutput.writeUserContent(productor.getIdProductor());
			jteOutput.writeContent("\">\r\n                                          <i class=\"fas fa-edit\"></i>\r\n                                        </a>\r\n                                        <button type=\"button\" class=\"btn btn-danger btn-xs no-gutters\" onClick=\"borrar(");
